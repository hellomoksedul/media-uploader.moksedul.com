  ...
  return (
    ...
    >
      <AlertDialogContent className="sm:max-w-[400px] p-0 overflow-hidden gap-0 border-border dark:border-border shadow-xl dark:shadow-2xl dark:shadow-black/50">
        ...
        <div className="px-6 pb-8 flex flex-col sm:flex-row gap-3 justify-center w-full">
          <AlertDialogCancel
            disabled={isLoading}
            onClick={onClose}
            className="flex-1 m-0 h-10 bg-background dark:bg-muted hover:bg-muted dark:hover:bg-muted border-border dark:border-border"
          >
            {cancelText}
          </AlertDialogCancel>
          <AlertDialogAction
